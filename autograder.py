        ...
        if sanity_pass:
            ...
            try:
                ...
                try:
                    ...
                    iam_ro_access_flag, ec2_ro_access_flag, s3_full_access_flag, sqs_full_access_flag, db_full_access_flag = iam_obj.validate_policies()
                    ...
                    aws_grader    = grader_project1(logger, asuid, cred_values[0], cred_values[1], ec2_ro_access_flag, s3_full_access_flag, sqs_full_access_flag, db_full_access_flag)
